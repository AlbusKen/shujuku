...
import { buildDefaultContinuationSettings_ACU, CONTINUATION_PROMPT_FORCE_DEFAULT_VERSION_V27_ACU, CONTINUATION_PROMPT_FORCE_DEFAULT_VERSION_V32_ACU } from '../../../src/service/continuation/defaults';
import {
...
describe('默认提示词谱系迁移', () => {
  ...
  it.each(labels)('%s 的默认组迁移后与当前默认组逐段一致', label => {
    ...
    expect(loaded.promptForceDefaultVersion).toBe(CONTINUATION_PROMPT_FORCE_DEFAULT_VERSION_V32_ACU);
