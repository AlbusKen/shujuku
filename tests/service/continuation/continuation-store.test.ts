...
describe('FirstFloorContinuationStore_ACU', () => {
  ...
  it('V17 仅定向更新已知会话快照规则，并保留其余提示词与段字段', () => {
    ...
    expect(loaded.settings.promptForceDefaultVersion).toBe('spv3.8-continuation-fixed-workflow-v30');
  ...
  it('V26 用户的默认上下文段升级为 V27 账本注入版，改写过的段保留原文', () => {
    ...
    expect(kept.settings.promptForceDefaultVersion).toBe('spv3.8-continuation-fixed-workflow-v30');
